...
\begin{document}
  ...
  Since $\Bij$ is a groupoid, each $\FMGpd X$ has a homotopy level of at least that of a groupoid.
  ...
  In any case, we recover $\FMSet$ by truncating the higher structure of $\FMGpd$:
  \begin{theorem}
  ...
  When defined in terms of $\Bij$, $\FMGpd$ is a small type family,
  and so is $L_{\FMGpd}$.
  ...
  We are able to show that the set-truncation of the groupoid-limit \SetTrunc{L_{\FMGpd}} is a fixpoint of $\FMSet$, i.e. $\FMSet \SetTrunc{L_{\FMGpd}} ≃ \SetTrunc{L_{\FMGpd}}$.
  ...
  \begin{theorem}
    Assuming the (full) axiom of choice, $\SetTrunc{L_{\FMGpd}}$ is the final coalgebra of $\FMSet$.
  \end{theorem}
