...
For any claim in this paper decorated with an \texttt{Identifier},
the repository contains instructions where to find the corresponding formalization.
...
\begin{proof}
  ...
  and \eqref{thm:FMSetFixpointOfTrunc:step3} follows from \cref{thm:BagPresLim}.
