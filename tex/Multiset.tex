...
The material presented in the paper (apart from Section~\ref{sec:analytic}) has been formalized in the Cubical Agda proof assistant.
...
\begin{proof}
  ...
  $\beta$ follows from Theorems~\ref{thm:FMSetOfFMGpdTrunc} and \ref{prop:BagTote},
