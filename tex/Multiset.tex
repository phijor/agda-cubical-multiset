...
\end{align*}
Transition systems can be encoded as coalgebra for $\FCM$ as follows:
\vspace{-.8cm}
\[
...
\subsection{As a Quotient of Lists}\label{sec:quot-list}
>>>>>>> 4a8d832 (Proof of naturality of equivalences between different presentations of finite multisets)
